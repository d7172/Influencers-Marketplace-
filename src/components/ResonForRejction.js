...
function ResonForRejction() {
  return (
    <div className="w-[550px] h-[550px] flex justify-center items-center flex-col">
      ...
      <button className="bg-[#3751FF] text-white w-[400px] h-[47px] rounded-full mt-10">Submit</button>
    </div>
  );
}
