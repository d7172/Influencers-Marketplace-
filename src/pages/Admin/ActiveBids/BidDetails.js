        ...
        <div>
          <div className="mb-8 w-[77%]">
            ...
            <p classname="text-sm font-[400] text-[#93939399]">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Autem ipsum accusantium dicta veritatis deserunt
              laborum vero dolorem fuga ex quia sed nam, voluptas voluptates officiis. Quae, et? Eligendi accusantium
              debitis dolores commodi id. Laborum, impedit?
            </p>
          </div>
          <div className="w-full my-8 h-[2px] bg-[#EEEEEE]"></div>
          <div className="mb-8 w-[77%]">
            ...
            <p classname="text-sm font-[400] text-[#93939399]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi magnam maxime non animi obcaecati
              reprehenderit delectus. Culpa omnis voluptatem enim necessitatibus voluptas sed repellat nulla,
              consectetur fuga tenetur vero, velit expedita cumque, nobis repudiandae modi.
            </p>
          </div>
          <div className="w-full my-8 h-[2px] bg-[#EEEEEE]"></div>
          <div className="mb-8 w-[77%]">
