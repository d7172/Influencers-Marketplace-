            ...
            <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
              <div className="overflow-x-auto">
                <table className="min-w-full">
                  ...
                  <tbody>
                    <tr className="">
                      <td className="pl-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#00001</td>
                      {brand ? (
                        <td className="text-sm flex gap-4 items-center justify-center overflow-hidden text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="text-sm max-w-[170px] text-gray-900 font-light px-6 py-4 whitespace-nowrap">10</td>
                      {brand && (
                        <td className="text-sm max-w-[170px] text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                          1
                        </td>
                      )}
                      <td className="text-sm max-w-[170px] text-gray-900 font-light px-6 py-4 whitespace-nowrap">1</td>
                      <td
                        onClick={() => {}}
