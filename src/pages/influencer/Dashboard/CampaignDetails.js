  ...
  return (
    <div className="mt-6 px-6 pb-10">
      ...
      {campDetails ? (
        ...
        : (
          <>
            <Breadcrumbs options={[{ title: "campaign" }, { title: route }, { title: infBidDetails.campaign_details?.id }]} />
            <div className="ml-4">
              <div className="flex justify-between">
                ...
                <div className="mt-6 flex items-start border border-[#F4F5F9] rounded px-6 py-2" >
                  <div className="mr-4 mt-2" >
                    <span className="inline-block" ><img src="/svgs/calendar.svg" width="25px" height="25px" /></span>
                  </div>
                  <div className="flex flex-col" >
                    <h1 className="text-start text-xl font-bold "> You Bid No : 1</h1>
                    {(infBidDetails.campaign_details.status !== 1) ? (<> <p className="text-sm text-[#93939399]" >(Bid Rejected)</p>
                      <p className=" text-start font-bold text-[#FF1800] line-through">
                        &#8377;{infBidDetails.influencer_bid_amount}</p>
              ...
              {infBidDetails.campaign_details.status !== 1 && <div>
                <hr className="my-8" />
                <button
                  onClick={() => setPlaceBid(true)}
                  className="bg-[#3751FF] rounded-full text-white w-[171px] h-[54px] mr-10"
